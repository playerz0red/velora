...
internal val logger: SkipLogger = SkipLogger(subsystem = "velora.app", category = "VeloraApp")

private typealias AppRootView = VeloraAppRootView
private typealias AppDelegate = VeloraAppAppDelegate
